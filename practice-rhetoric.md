...
- <Череда фактов>Череда фактов: когда тезис подкрепляется целой чередой фактов или статистикой. (Хороший пример использования у президента Путина)
...
- Стих  
- <Шокирующее заявление>Шокирующее заявление, или парадокс - чтобы захватить внимание. "Война — это мир, свобода — это рабство, незнание — сила." (1984)
- <Использование аналогий и метафор>Использование аналогий и метафор. Пример аналогии: "Хлеб чёрствый как камень". Пример метафоры: "Сердце чёрствое как камень". В аналогии сравнение правильно в прямом смысле, когда как в метафоре сравнение верно только в переносном смысле.
...
- <пространство>Придти в зал заранее и изучить пространство. Люди должны приходить к тебе.
- <как дела>Поинтересоваться как дела, спросить если можно улучшить обстановку.
- <пересесть поближе>Попросить пересесть поближе. Важно чтобы радиус влияния обхватывал слушателей. Накрыть умом и облучать из верхних чакр.   
...
- <Невербальные проявления агрессии>Невербальные проявления агрессии:   
...
- <Вербальные проявления агрессии>Вербальные проявления агрессии: 
...
- <Вербальные сигналы силы>Вербальные сигналы силы: "Задумайтесь", "Посмотрим на это с другой стороны", "А может это так?", "А как вы считаете?"
- <Невербальные сигналы силы>Невербальные сигналы силы: открытые руки, прямой взгляд, теплый голос, расслабленная походка.
<Тезис 2.4 - поза> Если аудиенция маленькая то поза - сидя.
- <прямая спина>Важно помнить что ты проводник высокой энергии и поза должна быть соответствующей - прямая спина.
- <движения>Если Зал побольше - то поза стоя. Совершать движения  но не резкие, руки открытые
- <выше>Желательно находится выше слушателей (пример про медведя)
- <признавать глазами>Глазами нужно быть с аудиторией, время от времени нужно признавать глазами каждого слушателя.
<Тезис 2.5 - как справляться с враждебностью> Если есть враждебные слушатели - то используйте следующие приёмы:
- <К сожалению>Нельзя ввязываться в спор. Нужно поблагодарить, отложить на другое время."К сожалению этот разговор интересен только для вас и меня"
- <ответ на суд>Отвечая на вопрос нужно смотреть в глаза тому кто спросил. После ответа обвести вся аудиторию взглядом, пустить ответ на суд общественности. Смотреть человеку нужно в правый глаз.Если нужно избежать взгляда - то смотреть в точку на лбу между глаз.
